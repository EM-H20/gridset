...
| F08 PNG 저장 / F09 MP4 저장 — share-first 흐름 (PR #7 진행 중) | 본 spec 의 셀 매핑(`_MappedThumb` + `mediaByCellId`)이 share 출력으로 이어짐. 자세한 spec: [`2026-04-27-share-output-design.md`](./2026-04-27-share-output-design.md) |
